...
void lerCSVCli(FILE *file2, struct clientes dados[], int *numDados)
{
    ...
    sscanf(linha, "%49[^,],%49[^,],%49[^,],%49[^,],%f,%d,%d,%d,%d,%d,%49[^,],%d",
...
bool validacaoIngresso(FILE *file2, struct clientes dados[], int numDados, float buscaTicket)
{
...
int main()
{
    ...
    while (1)
    {
        ...
        case 3:
            ...
            scanf("%f", &buscaTicket);
            if (validacaoIngresso(file2, dados, numDados, buscaTicket))
            {
